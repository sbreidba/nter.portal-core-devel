...
public class ComponentRecordLocalServiceClp
    implements ComponentRecordLocalService {
    private ClassLoaderProxy _classLoaderProxy;
    private MethodKey _addComponentRecordMethodKey0;
    private MethodKey _createComponentRecordMethodKey1;
    private MethodKey _deleteComponentRecordMethodKey2;
    private MethodKey _deleteComponentRecordMethodKey3;
    private MethodKey _dynamicQueryMethodKey4;
    private MethodKey _dynamicQueryMethodKey5;
    private MethodKey _dynamicQueryMethodKey6;
    private MethodKey _dynamicQueryCountMethodKey7;
    private MethodKey _fetchComponentRecordMethodKey8;
    private MethodKey _getComponentRecordMethodKey9;
    private MethodKey _getPersistedModelMethodKey10;
    private MethodKey _getComponentRecordsMethodKey11;
    private MethodKey _getComponentRecordsCountMethodKey12;
    private MethodKey _updateComponentRecordMethodKey13;
    ...
    public ComponentRecordLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
        ...
        _addComponentRecordMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
                "addComponentRecord",
                org.nterlearning.datamodel.catalog.model.ComponentRecord.class);

        _createComponentRecordMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
                "createComponentRecord", long.class);

        _deleteComponentRecordMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
                "deleteComponentRecord", long.class);

        _deleteComponentRecordMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
        ...
        _fetchComponentRecordMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
                "fetchComponentRecord", long.class);

        _getComponentRecordMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
                "getComponentRecord", long.class);

        _getPersistedModelMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
                "getPersistedModel", java.io.Serializable.class);

        _getComponentRecordsMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
                "getComponentRecords", int.class, int.class);

        _getComponentRecordsCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
                "getComponentRecordsCount");

        _updateComponentRecordMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateComponentRecord",
                org.nterlearning.datamodel.catalog.model.ComponentRecord.class);

        _updateComponentRecordMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
                "updateComponentRecord",
                org.nterlearning.datamodel.catalog.model.ComponentRecord.class,
                boolean.class);
    ...
    public org.nterlearning.datamodel.catalog.model.ComponentRecord addComponentRecord(
        ...
        MethodHandler methodHandler = new MethodHandler(_addComponentRecordMethodKey0,
                ClpSerializer.translateInput(componentRecord));
        ...
        return (org.nterlearning.datamodel.catalog.model.ComponentRecord) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public org.nterlearning.datamodel.catalog.model.ComponentRecord createComponentRecord(
        ...
        MethodHandler methodHandler = new MethodHandler(_createComponentRecordMethodKey1,
                componentRecordId);
    ...
    public void deleteComponentRecord(long componentRecordId)
        ...
        MethodHandler methodHandler = new MethodHandler(_deleteComponentRecordMethodKey2,
                componentRecordId);
    ...
    public void deleteComponentRecord(
        org.nterlearning.datamodel.catalog.model.ComponentRecord componentRecord)
        throws com.liferay.portal.kernel.exception.SystemException {
        MethodHandler methodHandler = new MethodHandler(_deleteComponentRecordMethodKey3,
                ClpSerializer.translateInput(componentRecord));
    ...
    public org.nterlearning.datamodel.catalog.model.ComponentRecord fetchComponentRecord(
        ...
        MethodHandler methodHandler = new MethodHandler(_fetchComponentRecordMethodKey8,
                componentRecordId);
    ...
    public org.nterlearning.datamodel.catalog.model.ComponentRecord getComponentRecord(
        ...
        MethodHandler methodHandler = new MethodHandler(_getComponentRecordMethodKey9,
                componentRecordId);
    ...
    public java.util.List<org.nterlearning.datamodel.catalog.model.ComponentRecord> getComponentRecords(
        ...
        MethodHandler methodHandler = new MethodHandler(_getComponentRecordsMethodKey11,
                start, end);
    ...
    public int getComponentRecordsCount()
        ...
        MethodHandler methodHandler = new MethodHandler(_getComponentRecordsCountMethodKey12);
    ...
    public org.nterlearning.datamodel.catalog.model.ComponentRecord updateComponentRecord(
        ...
        MethodHandler methodHandler = new MethodHandler(_updateComponentRecordMethodKey13,
                ClpSerializer.translateInput(componentRecord));
    ...
    public org.nterlearning.datamodel.catalog.model.ComponentRecord updateComponentRecord(
        ...
        MethodHandler methodHandler = new MethodHandler(_updateComponentRecordMethodKey14,
                ClpSerializer.translateInput(componentRecord), merge);
