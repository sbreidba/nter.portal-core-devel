...
<ul class="reviewlist" data-more-url="<%= moreURL %>" data-start-param-name="_coursereviews_WAR_courseportlet_start" data-per-page="<%= coursesPerPage %>" data-total="<%= reviewCount %>">
...
<ul class="reviewlist" data-more-url="<%= remoteMoreURL %>" data-start-param-name="_coursereviews_WAR_courseportlet_start" data-per-page="<%= coursesPerPage %>" data-total="<%= globalReviewCount %>">
