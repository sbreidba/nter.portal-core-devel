...
PortalUtil.addPageSubtitle(LanguageUtil.get(pageContext, "flag-review"), PortalUtil.getHttpServletRequest(renderRequest));
...
<p><%= LanguageUtil.get(pageContext,"flag-thanks") %></p>
