...
<%
    ...
    CourseReview courseReview = CourseReviewLocalServiceUtil.getCourseReview(classPK);
    long reportedUserId = courseReview.getUserId();

    // fill in title with PK and first few characters of content
    String contentTitle = "Inappropriate Review: classPK=" + classPK + "; Content: " + StringUtil.shorten(courseReview.getContent(), 30); ;
