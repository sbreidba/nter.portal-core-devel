...
public class ContributorLocalServiceImpl extends ContributorLocalServiceBaseImpl {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never reference this interface directly. Always use {@link org.nterlearning.datamodel.catalog.service.ContributorLocalServiceUtil} to access the contributor local service.
     */
}
