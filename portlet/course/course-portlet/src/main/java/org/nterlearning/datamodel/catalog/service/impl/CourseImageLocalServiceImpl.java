...
public class CourseImageLocalServiceImpl extends CourseImageLocalServiceBaseImpl {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never reference this interface directly. Always use {@link org.nterlearning.datamodel.catalog.service.CourseImageLocalServiceUtil} to access the course image local service.
     */
}
