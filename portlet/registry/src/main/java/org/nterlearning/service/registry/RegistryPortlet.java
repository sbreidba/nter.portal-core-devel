...
public class RegistryPortlet extends MVCPortlet {
    ...
    private final String editInstitutionJSP = "/html/cp-reg/editInstitution.jsp";
    private final String viewInstitutionsJSP = "/html/cp-reg/viewInstitutions.jsp";
    private final String viewInstitutionJSP = "/html/cp-reg/viewInstitution.jsp";
    private final String viewServicesJSP = "/html/cp-reg/viewServices.jsp";
    private final String viewServiceJSP = "/html/cp-reg/viewService.jsp";
    private final String editServiceJSP = "/html/cp-reg/editService.jsp";
    private final String editBindingJSP = "/html/cp-reg/editBinding.jsp";
