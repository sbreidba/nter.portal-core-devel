...
public class NterCategory extends ExtensibleElementWrapper {
	...
	public NterId getCategoryId(){
		return getExtension(mNterExtension.getQName(NterExtension.ID_ELEMENT_NAME));
	}

	public void setCategoryId(NterId id){
		addExtension(id);
	}
}