...
/**
 * The base implementation of the global course review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.GlobalCourseReviewLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class GlobalCourseReviewLocalServiceBaseImpl
    implements GlobalCourseReviewLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(GlobalCourseReviewLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.GlobalCourseReviewLocalServiceUtil} to access the global course review local service.
     */
     ...
     */
    public GlobalCourseReview addGlobalCourseReview(
        GlobalCourseReview globalCourseReview) throws SystemException {
        globalCourseReview.setNew(true);

        globalCourseReview = globalCourseReviewPersistence.update(globalCourseReview,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(globalCourseReview);
     ...
     */
    public GlobalCourseReview createGlobalCourseReview(
        long globalCourseReviewId) {
        return globalCourseReviewPersistence.create(globalCourseReviewId);
    }
    ...
    public void deleteGlobalCourseReview(long globalCourseReviewId)
        ...
        GlobalCourseReview globalCourseReview = globalCourseReviewPersistence.remove(globalCourseReviewId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(globalCourseReview);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteGlobalCourseReview(GlobalCourseReview globalCourseReview)
        throws SystemException {
        globalCourseReviewPersistence.remove(globalCourseReview);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return globalCourseReviewPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return globalCourseReviewPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public GlobalCourseReview fetchGlobalCourseReview(long globalCourseReviewId)
        throws SystemException {
        return globalCourseReviewPersistence.fetchByPrimaryKey(globalCourseReviewId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public GlobalCourseReview getGlobalCourseReview(long globalCourseReviewId)
        throws PortalException, SystemException {
        return globalCourseReviewPersistence.findByPrimaryKey(globalCourseReviewId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return globalCourseReviewPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<GlobalCourseReview> getGlobalCourseReviews(int start, int end)
        throws SystemException {
        return globalCourseReviewPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getGlobalCourseReviewsCount() throws SystemException {
        return globalCourseReviewPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public GlobalCourseReview updateGlobalCourseReview(
        GlobalCourseReview globalCourseReview) throws SystemException {
        return updateGlobalCourseReview(globalCourseReview, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.GlobalCourseReview",
            globalCourseReviewLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.GlobalCourseReview");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = globalCourseReviewPersistence.getDataSource();
