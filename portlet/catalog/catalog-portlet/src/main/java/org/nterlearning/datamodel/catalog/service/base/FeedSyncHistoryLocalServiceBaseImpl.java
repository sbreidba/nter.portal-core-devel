...
/**
 * The base implementation of the feed sync history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.FeedSyncHistoryLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FeedSyncHistoryLocalServiceBaseImpl
    implements FeedSyncHistoryLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(FeedSyncHistoryLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.FeedSyncHistoryLocalServiceUtil} to access the feed sync history local service.
     */
     ...
     */
    public FeedSyncHistory addFeedSyncHistory(FeedSyncHistory feedSyncHistory)
        throws SystemException {
        feedSyncHistory.setNew(true);

        feedSyncHistory = feedSyncHistoryPersistence.update(feedSyncHistory,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(feedSyncHistory);
     ...
     */
    public FeedSyncHistory createFeedSyncHistory(long syncId) {
        return feedSyncHistoryPersistence.create(syncId);
    }
    ...
    public void deleteFeedSyncHistory(long syncId)
        ...
        FeedSyncHistory feedSyncHistory = feedSyncHistoryPersistence.remove(syncId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(feedSyncHistory);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteFeedSyncHistory(FeedSyncHistory feedSyncHistory)
        throws SystemException {
        feedSyncHistoryPersistence.remove(feedSyncHistory);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return feedSyncHistoryPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return feedSyncHistoryPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public FeedSyncHistory fetchFeedSyncHistory(long syncId)
        throws SystemException {
        return feedSyncHistoryPersistence.fetchByPrimaryKey(syncId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FeedSyncHistory getFeedSyncHistory(long syncId)
        throws PortalException, SystemException {
        return feedSyncHistoryPersistence.findByPrimaryKey(syncId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return feedSyncHistoryPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<FeedSyncHistory> getFeedSyncHistories(int start, int end)
        throws SystemException {
        return feedSyncHistoryPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getFeedSyncHistoriesCount() throws SystemException {
        return feedSyncHistoryPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FeedSyncHistory updateFeedSyncHistory(
        FeedSyncHistory feedSyncHistory) throws SystemException {
        return updateFeedSyncHistory(feedSyncHistory, true);
    }
     ...
     */
    public FeedSyncHistory updateFeedSyncHistory(
        FeedSyncHistory feedSyncHistory, boolean merge)
        throws SystemException {
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.FeedSyncHistory",
            feedSyncHistoryLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.FeedSyncHistory");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = feedSyncHistoryPersistence.getDataSource();
