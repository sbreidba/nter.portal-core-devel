...
/**
 * The base implementation of the contributor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.ContributorLocalServiceImpl}.
 * </p>
 *
...
public abstract class ContributorLocalServiceBaseImpl
    implements ContributorLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ContributorLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.ContributorLocalServiceUtil} to access the contributor local service.
     */
    ...
    public Contributor addContributor(Contributor contributor)
        ...
        contributor = contributorPersistence.update(contributor, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(contributor);
    ...
    public void deleteContributor(long contributorId)
        ...
        Contributor contributor = contributorPersistence.remove(contributorId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(contributor);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteContributor(Contributor contributor)
        throws SystemException {
        contributorPersistence.remove(contributor);
    ...
    public Contributor updateContributor(Contributor contributor)
        throws SystemException {
        return updateContributor(contributor, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Contributor updateContributor(Contributor contributor, boolean merge)
        throws SystemException {
        contributor.setNew(false);

        contributor = contributorPersistence.update(contributor, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.Contributor",
            contributorLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.Contributor");
    }
