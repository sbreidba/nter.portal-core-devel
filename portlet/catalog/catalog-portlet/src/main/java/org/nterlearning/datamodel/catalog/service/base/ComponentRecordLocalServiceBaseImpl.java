...
/**
 * The base implementation of the component record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.ComponentRecordLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see org.nterlearning.datamodel.catalog.service.impl.ComponentRecordLocalServiceImpl
 * @see org.nterlearning.datamodel.catalog.service.ComponentRecordLocalServiceUtil
 * @generated
 */
public abstract class ComponentRecordLocalServiceBaseImpl
    implements ComponentRecordLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(ComponentRecordLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.ComponentRecordLocalServiceUtil} to access the component record local service.
     */
    ...
    public ComponentRecord addComponentRecord(ComponentRecord componentRecord)
        ...
        componentRecord = componentRecordPersistence.update(componentRecord,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(componentRecord);
     ...
     */
    public ComponentRecord createComponentRecord(long componentRecordId) {
        return componentRecordPersistence.create(componentRecordId);
    }
    ...
    public void deleteComponentRecord(long componentRecordId)
        ...
        ComponentRecord componentRecord = componentRecordPersistence.remove(componentRecordId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(componentRecord);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteComponentRecord(ComponentRecord componentRecord)
        throws SystemException {
        componentRecordPersistence.remove(componentRecord);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return componentRecordPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return componentRecordPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public ComponentRecord fetchComponentRecord(long componentRecordId)
        throws SystemException {
        return componentRecordPersistence.fetchByPrimaryKey(componentRecordId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ComponentRecord getComponentRecord(long componentRecordId)
        throws PortalException, SystemException {
        return componentRecordPersistence.findByPrimaryKey(componentRecordId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return componentRecordPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<ComponentRecord> getComponentRecords(int start, int end)
        throws SystemException {
        return componentRecordPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getComponentRecordsCount() throws SystemException {
        return componentRecordPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public ComponentRecord updateComponentRecord(
        ComponentRecord componentRecord) throws SystemException {
        return updateComponentRecord(componentRecord, true);
    }
     ...
     */
    public ComponentRecord updateComponentRecord(
        ComponentRecord componentRecord, boolean merge)
        throws SystemException {
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.ComponentRecord",
            componentRecordLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.ComponentRecord");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = componentRecordPersistence.getDataSource();
