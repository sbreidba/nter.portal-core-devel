...
public class CourseImpl extends CourseBaseImpl {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never reference this class directly. All methods that expect a course model instance should use the {@link org.nterlearning.datamodel.catalog.model.Course} interface instead.
     */
    public CourseImpl() {
    }
}
