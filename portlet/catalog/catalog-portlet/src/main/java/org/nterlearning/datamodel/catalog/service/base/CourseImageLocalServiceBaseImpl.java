...
/**
 * The base implementation of the course image local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.CourseImageLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CourseImageLocalServiceBaseImpl
    implements CourseImageLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(CourseImageLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.CourseImageLocalServiceUtil} to access the course image local service.
     */
     ...
     */
    public CourseImage addCourseImage(CourseImage courseImage)
        throws SystemException {
        courseImage.setNew(true);

        courseImage = courseImagePersistence.update(courseImage, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(courseImage);
     ...
     */
    public CourseImage createCourseImage(long courseImageId) {
        return courseImagePersistence.create(courseImageId);
    }
    ...
    public void deleteCourseImage(long courseImageId)
        ...
        CourseImage courseImage = courseImagePersistence.remove(courseImageId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(courseImage);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteCourseImage(CourseImage courseImage)
        throws SystemException {
        courseImagePersistence.remove(courseImage);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseImagePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return courseImagePersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseImagePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public CourseImage fetchCourseImage(long courseImageId)
        throws SystemException {
        return courseImagePersistence.fetchByPrimaryKey(courseImageId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseImage getCourseImage(long courseImageId)
        throws PortalException, SystemException {
        return courseImagePersistence.findByPrimaryKey(courseImageId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return courseImagePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<CourseImage> getCourseImages(int start, int end)
        throws SystemException {
        return courseImagePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getCourseImagesCount() throws SystemException {
        return courseImagePersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseImage updateCourseImage(CourseImage courseImage)
        throws SystemException {
        return updateCourseImage(courseImage, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseImage updateCourseImage(CourseImage courseImage, boolean merge)
        throws SystemException {
        courseImage.setNew(false);

        courseImage = courseImagePersistence.update(courseImage, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.CourseImage",
            courseImageLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.CourseImage");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = courseImagePersistence.getDataSource();
