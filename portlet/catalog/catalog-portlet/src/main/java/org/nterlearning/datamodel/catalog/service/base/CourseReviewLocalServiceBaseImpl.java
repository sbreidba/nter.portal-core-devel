...
/**
 * The base implementation of the course review local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.CourseReviewLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CourseReviewLocalServiceBaseImpl
    implements CourseReviewLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(CourseReviewLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.CourseReviewLocalServiceUtil} to access the course review local service.
     */
    ...
    public CourseReview addCourseReview(CourseReview courseReview)
        ...
        courseReview = courseReviewPersistence.update(courseReview, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(courseReview);
     ...
     */
    public CourseReview createCourseReview(long courseReviewId) {
        return courseReviewPersistence.create(courseReviewId);
    }
    ...
    public void deleteCourseReview(long courseReviewId)
        ...
        CourseReview courseReview = courseReviewPersistence.remove(courseReviewId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(courseReview);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseReviewPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseReviewPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public CourseReview fetchCourseReview(long courseReviewId)
        throws SystemException {
        return courseReviewPersistence.fetchByPrimaryKey(courseReviewId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseReview getCourseReview(long courseReviewId)
        throws PortalException, SystemException {
        return courseReviewPersistence.findByPrimaryKey(courseReviewId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return courseReviewPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<CourseReview> getCourseReviews(int start, int end)
        throws SystemException {
        return courseReviewPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getCourseReviewsCount() throws SystemException {
        return courseReviewPersistence.countAll();
    }
    ...
    public CourseReview updateCourseReview(CourseReview courseReview)
        throws SystemException {
        return updateCourseReview(courseReview, true);
    }
    ...
    public CourseReview updateCourseReview(CourseReview courseReview,
        ...
        courseReview = courseReviewPersistence.update(courseReview, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.CourseReview",
            courseReviewLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.CourseReview");
    }
