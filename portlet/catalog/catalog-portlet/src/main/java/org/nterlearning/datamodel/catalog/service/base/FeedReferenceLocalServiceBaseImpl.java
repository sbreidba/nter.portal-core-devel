...
/**
 * The base implementation of the feed reference local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.FeedReferenceLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FeedReferenceLocalServiceBaseImpl
    implements FeedReferenceLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(FeedReferenceLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.FeedReferenceLocalServiceUtil} to access the feed reference local service.
     */
    ...
    public FeedReference addFeedReference(FeedReference feedReference)
        ...
        feedReference = feedReferencePersistence.update(feedReference, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(feedReference);
     ...
     */
    public FeedReference createFeedReference(long feedReferenceId) {
        return feedReferencePersistence.create(feedReferenceId);
    }
    ...
    public void deleteFeedReference(long feedReferenceId)
        ...
        FeedReference feedReference = feedReferencePersistence.remove(feedReferenceId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(feedReference);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteFeedReference(FeedReference feedReference)
        throws SystemException {
        feedReferencePersistence.remove(feedReference);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return feedReferencePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return feedReferencePersistence.countWithDynamicQuery(dynamicQuery);
    }

    public FeedReference fetchFeedReference(long feedReferenceId)
        throws SystemException {
        return feedReferencePersistence.fetchByPrimaryKey(feedReferenceId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FeedReference getFeedReference(long feedReferenceId)
        throws PortalException, SystemException {
        return feedReferencePersistence.findByPrimaryKey(feedReferenceId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return feedReferencePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<FeedReference> getFeedReferences(int start, int end)
        throws SystemException {
        return feedReferencePersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getFeedReferencesCount() throws SystemException {
        return feedReferencePersistence.countAll();
    }
    ...
    public FeedReference updateFeedReference(FeedReference feedReference,
        ...
        feedReference = feedReferencePersistence.update(feedReference, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.FeedReference",
            feedReferenceLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.FeedReference");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = feedReferencePersistence.getDataSource();
