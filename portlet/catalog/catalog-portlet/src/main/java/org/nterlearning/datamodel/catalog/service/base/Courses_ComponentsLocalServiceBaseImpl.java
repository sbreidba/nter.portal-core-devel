...
/**
 * The base implementation of the courses_ components local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.Courses_ComponentsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class Courses_ComponentsLocalServiceBaseImpl
    implements Courses_ComponentsLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(Courses_ComponentsLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.Courses_ComponentsLocalServiceUtil} to access the courses_ components local service.
     */
     ...
     */
    public Courses_Components addCourses_Components(
        Courses_Components courses_Components) throws SystemException {
        courses_Components.setNew(true);

        courses_Components = courses_ComponentsPersistence.update(courses_Components,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(courses_Components);
     ...
     */
    public Courses_Components createCourses_Components(long coursesComponentsId) {
        return courses_ComponentsPersistence.create(coursesComponentsId);
    }
    ...
    public void deleteCourses_Components(long coursesComponentsId)
        ...
        Courses_Components courses_Components = courses_ComponentsPersistence.remove(coursesComponentsId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(courses_Components);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteCourses_Components(Courses_Components courses_Components)
        throws SystemException {
        courses_ComponentsPersistence.remove(courses_Components);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return courses_ComponentsPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return courses_ComponentsPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Courses_Components fetchCourses_Components(long coursesComponentsId)
        throws SystemException {
        return courses_ComponentsPersistence.fetchByPrimaryKey(coursesComponentsId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Courses_Components getCourses_Components(long coursesComponentsId)
        throws PortalException, SystemException {
        return courses_ComponentsPersistence.findByPrimaryKey(coursesComponentsId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return courses_ComponentsPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Courses_Components> getCourses_Componentses(int start, int end)
        throws SystemException {
        return courses_ComponentsPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getCourses_ComponentsesCount() throws SystemException {
        return courses_ComponentsPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public Courses_Components updateCourses_Components(
        Courses_Components courses_Components) throws SystemException {
        return updateCourses_Components(courses_Components, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.Courses_Components",
            courses_ComponentsLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.Courses_Components");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = courses_ComponentsPersistence.getDataSource();
