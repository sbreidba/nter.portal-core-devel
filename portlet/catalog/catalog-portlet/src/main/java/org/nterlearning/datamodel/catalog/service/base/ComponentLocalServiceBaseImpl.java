...
/**
 * The base implementation of the component local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.ComponentLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ComponentLocalServiceBaseImpl
    implements ComponentLocalService, IdentifiableBean {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.ComponentLocalServiceUtil} to access the component local service.
     */
    ...
    public Component addComponent(Component component)
        ...
        component = componentPersistence.update(component, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(component);
     ...
     */
    public Component createComponent(long componentId) {
        return componentPersistence.create(componentId);
    }
    ...
    public void deleteComponent(long componentId)
        ...
        Component component = componentPersistence.remove(componentId);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return componentPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return componentPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return componentPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public Component fetchComponent(long componentId) throws SystemException {
        return componentPersistence.fetchByPrimaryKey(componentId);
    }
    ...
    public Component getComponent(long componentId)
        throws PortalException, SystemException {
        return componentPersistence.findByPrimaryKey(componentId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return componentPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<Component> getComponents(int start, int end)
        throws SystemException {
        return componentPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getComponentsCount() throws SystemException {
        return componentPersistence.countAll();
    }
    ...
    public Component updateComponent(Component component)
        throws SystemException {
        return updateComponent(component, true);
    }
    ...
    public Component updateComponent(Component component, boolean merge)
        ...
        component = componentPersistence.update(component, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.Component",
            componentLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.Component");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = componentPersistence.getDataSource();
