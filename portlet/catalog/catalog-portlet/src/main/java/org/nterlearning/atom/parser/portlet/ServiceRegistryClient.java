...
public class ServiceRegistryClient {
    ...
    public static final Set<BindingTypeEnum> CONTENT_BINDING_TYPES = new HashSet<BindingTypeEnum>();
    static {
        CONTENT_BINDING_TYPES.add(BindingTypeEnum.ACTIVITY_STREAM_ATOM);
        CONTENT_BINDING_TYPES.add(BindingTypeEnum.COURSE_CATALOG_ATOM);
        CONTENT_BINDING_TYPES.add(BindingTypeEnum.STUDENT_PROGRESS_ATOM);
    }
