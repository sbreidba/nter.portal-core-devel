...
public final class FlagReportQueryResult {
    ...
    FlagReportQueryResult(FlagReportStats flagReportStats, FlagReport flagReport, Date modifiedDate, String userDisplay, String contentType) {
        if (flagReport == null) {
