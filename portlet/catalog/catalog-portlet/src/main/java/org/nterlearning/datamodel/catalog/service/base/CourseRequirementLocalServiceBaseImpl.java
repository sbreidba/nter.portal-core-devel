...
/**
 * The base implementation of the course requirement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.CourseRequirementLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CourseRequirementLocalServiceBaseImpl
    implements CourseRequirementLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(CourseRequirementLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.CourseRequirementLocalServiceUtil} to access the course requirement local service.
     */
     ...
     */
    public CourseRequirement addCourseRequirement(
        CourseRequirement courseRequirement) throws SystemException {
        courseRequirement.setNew(true);

        courseRequirement = courseRequirementPersistence.update(courseRequirement,
                false);
        ...
        if (indexer != null) {
            try {
                indexer.reindex(courseRequirement);
     ...
     */
    public CourseRequirement createCourseRequirement(long courseRequirementId) {
        return courseRequirementPersistence.create(courseRequirementId);
    }
    ...
    public void deleteCourseRequirement(long courseRequirementId)
        ...
        CourseRequirement courseRequirement = courseRequirementPersistence.remove(courseRequirementId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(courseRequirement);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteCourseRequirement(CourseRequirement courseRequirement)
        throws SystemException {
        courseRequirementPersistence.remove(courseRequirement);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseRequirementPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseRequirementPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public CourseRequirement fetchCourseRequirement(long courseRequirementId)
        throws SystemException {
        return courseRequirementPersistence.fetchByPrimaryKey(courseRequirementId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseRequirement getCourseRequirement(long courseRequirementId)
        throws PortalException, SystemException {
        return courseRequirementPersistence.findByPrimaryKey(courseRequirementId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return courseRequirementPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<CourseRequirement> getCourseRequirements(int start, int end)
        throws SystemException {
        return courseRequirementPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getCourseRequirementsCount() throws SystemException {
        return courseRequirementPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseRequirement updateCourseRequirement(
        CourseRequirement courseRequirement) throws SystemException {
        return updateCourseRequirement(courseRequirement, true);
    }
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.CourseRequirement",
            courseRequirementLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.CourseRequirement");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = courseRequirementPersistence.getDataSource();
