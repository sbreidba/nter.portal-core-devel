...
/**
 * The base implementation of the course record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.CourseRecordLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CourseRecordLocalServiceBaseImpl
    implements CourseRecordLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(CourseRecordLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.CourseRecordLocalServiceUtil} to access the course record local service.
     */
    ...
    public CourseRecord addCourseRecord(CourseRecord courseRecord)
        ...
        courseRecord = courseRecordPersistence.update(courseRecord, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(courseRecord);
     ...
     */
    public CourseRecord createCourseRecord(long courseRecordId) {
        return courseRecordPersistence.create(courseRecordId);
    }
    ...
    public void deleteCourseRecord(long courseRecordId)
        ...
        CourseRecord courseRecord = courseRecordPersistence.remove(courseRecordId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(courseRecord);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
    ...
    public void deleteCourseRecord(CourseRecord courseRecord)
        throws PortalException, SystemException {
        courseRecordPersistence.remove(courseRecord);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseRecordPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseRecordPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public CourseRecord fetchCourseRecord(long courseRecordId)
        throws SystemException {
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseRecord getCourseRecord(long courseRecordId)
        throws PortalException, SystemException {
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return courseRecordPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<CourseRecord> getCourseRecords(int start, int end)
        throws SystemException {
        return courseRecordPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getCourseRecordsCount() throws SystemException {
        return courseRecordPersistence.countAll();
    }
    ...
    public CourseRecord updateCourseRecord(CourseRecord courseRecord)
        throws SystemException {
        return updateCourseRecord(courseRecord, true);
    }
    ...
    public CourseRecord updateCourseRecord(CourseRecord courseRecord,
        ...
        courseRecord = courseRecordPersistence.update(courseRecord, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.CourseRecord",
            courseRecordLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.CourseRecord");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = courseRecordPersistence.getDataSource();
