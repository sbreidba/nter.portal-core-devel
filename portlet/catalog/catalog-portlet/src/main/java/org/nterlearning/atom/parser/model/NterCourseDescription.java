...
public class NterCourseDescription extends ExtensibleElementWrapper {

	public NterCourseDescription(Element internal) {
		super(internal);
	}


	public NterCourseDescription(Factory factory, QName qname) {
		super(factory, qname);
	}
