...
/**
 * The base implementation of the course related local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.CourseRelatedLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CourseRelatedLocalServiceBaseImpl
    implements CourseRelatedLocalService, IdentifiableBean {
    private static Log _log = LogFactoryUtil.getLog(CourseRelatedLocalServiceBaseImpl.class);
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.CourseRelatedLocalServiceUtil} to access the course related local service.
     */
     ...
     */
    public CourseRelated addCourseRelated(CourseRelated courseRelated)
        throws SystemException {
        courseRelated.setNew(true);

        courseRelated = courseRelatedPersistence.update(courseRelated, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(courseRelated);
     ...
     */
    public CourseRelated createCourseRelated(long courseRelatedId) {
        return courseRelatedPersistence.create(courseRelatedId);
    }
    ...
    public void deleteCourseRelated(long courseRelatedId)
        ...
        CourseRelated courseRelated = courseRelatedPersistence.remove(courseRelatedId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(courseRelated);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteCourseRelated(CourseRelated courseRelated)
        throws SystemException {
        courseRelatedPersistence.remove(courseRelated);
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseRelatedPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return courseRelatedPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public CourseRelated fetchCourseRelated(long courseRelatedId)
        throws SystemException {
        return courseRelatedPersistence.fetchByPrimaryKey(courseRelatedId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseRelated getCourseRelated(long courseRelatedId)
        throws PortalException, SystemException {
        return courseRelatedPersistence.findByPrimaryKey(courseRelatedId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return courseRelatedPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<CourseRelated> getCourseRelateds(int start, int end)
        throws SystemException {
        return courseRelatedPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getCourseRelatedsCount() throws SystemException {
        return courseRelatedPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public CourseRelated updateCourseRelated(CourseRelated courseRelated)
        throws SystemException {
        return updateCourseRelated(courseRelated, true);
    }
    ...
    public CourseRelated updateCourseRelated(CourseRelated courseRelated,
        ...
        courseRelated = courseRelatedPersistence.update(courseRelated, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.CourseRelated",
            courseRelatedLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.CourseRelated");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = courseRelatedPersistence.getDataSource();
