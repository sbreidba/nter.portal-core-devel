...
/**
 * The base implementation of the flag report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.nterlearning.datamodel.catalog.service.impl.FlagReportLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class FlagReportLocalServiceBaseImpl
    implements FlagReportLocalService, IdentifiableBean {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link org.nterlearning.datamodel.catalog.service.FlagReportLocalServiceUtil} to access the flag report local service.
     */
     ...
     */
    public FlagReport addFlagReport(FlagReport flagReport)
        throws SystemException {
        flagReport.setNew(true);

        flagReport = flagReportPersistence.update(flagReport, false);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.reindex(flagReport);
     ...
     */
    public FlagReport createFlagReport(long flagReportId) {
        return flagReportPersistence.create(flagReportId);
    }
    ...
    public void deleteFlagReport(long flagReportId)
        ...
        FlagReport flagReport = flagReportPersistence.remove(flagReportId);

        Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

        if (indexer != null) {
            try {
                indexer.delete(flagReport);
            } catch (SearchException se) {
                if (_log.isWarnEnabled()) {
                    _log.warn(se, se);
                }
     ...
     * @throws SystemException if a system exception occurred
     */
    public void deleteFlagReport(FlagReport flagReport)
        throws SystemException {
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return flagReportPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return flagReportPersistence.findWithDynamicQuery(dynamicQuery, start,
            end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return flagReportPersistence.countWithDynamicQuery(dynamicQuery);
    }

    public FlagReport fetchFlagReport(long flagReportId)
        throws SystemException {
        return flagReportPersistence.fetchByPrimaryKey(flagReportId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FlagReport getFlagReport(long flagReportId)
        throws PortalException, SystemException {
        return flagReportPersistence.findByPrimaryKey(flagReportId);
    }

    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return flagReportPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FlagReport getFlagReportByUuidAndGroupId(String uuid, long groupId)
        throws PortalException, SystemException {
        return flagReportPersistence.findByUUID_G(uuid, groupId);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public List<FlagReport> getFlagReports(int start, int end)
        throws SystemException {
        return flagReportPersistence.findAll(start, end);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public int getFlagReportsCount() throws SystemException {
        return flagReportPersistence.countAll();
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FlagReport updateFlagReport(FlagReport flagReport)
        throws SystemException {
        return updateFlagReport(flagReport, true);
    }
     ...
     * @throws SystemException if a system exception occurred
     */
    public FlagReport updateFlagReport(FlagReport flagReport, boolean merge)
        throws SystemException {
        flagReport.setNew(false);

        flagReport = flagReportPersistence.update(flagReport, merge);
    ...
    public void afterPropertiesSet() {
        PersistedModelLocalServiceRegistryUtil.register("org.nterlearning.datamodel.catalog.model.FlagReport",
            flagReportLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "org.nterlearning.datamodel.catalog.model.FlagReport");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = flagReportPersistence.getDataSource();
