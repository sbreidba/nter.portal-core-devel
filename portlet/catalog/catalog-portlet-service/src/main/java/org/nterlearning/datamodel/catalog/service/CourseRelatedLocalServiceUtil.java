...
/**
 * The utility for the course related local service. This utility wraps {@link org.nterlearning.datamodel.catalog.service.impl.CourseRelatedLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class CourseRelatedLocalServiceUtil {
    private static CourseRelatedLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link org.nterlearning.datamodel.catalog.service.impl.CourseRelatedLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.CourseRelated addCourseRelated(
        org.nterlearning.datamodel.catalog.model.CourseRelated courseRelated)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addCourseRelated(courseRelated);
    }
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.CourseRelated createCourseRelated(
        long courseRelatedId) {
        return getService().createCourseRelated(courseRelatedId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteCourseRelated(long courseRelatedId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        getService().deleteCourseRelated(courseRelatedId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteCourseRelated(
        org.nterlearning.datamodel.catalog.model.CourseRelated courseRelated)
        throws com.liferay.portal.kernel.exception.SystemException {
        getService().deleteCourseRelated(courseRelated);
    }
    ...
    */
    ...
    public static org.nterlearning.datamodel.catalog.model.CourseRelated fetchCourseRelated(
        long courseRelatedId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchCourseRelated(courseRelatedId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static org.nterlearning.datamodel.catalog.model.CourseRelated getCourseRelated(
        long courseRelatedId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getCourseRelated(courseRelatedId);
    }
    ...
    */
    public static java.util.List<org.nterlearning.datamodel.catalog.model.CourseRelated> getCourseRelateds(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getCourseRelateds(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getCourseRelatedsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getCourseRelatedsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static org.nterlearning.datamodel.catalog.model.CourseRelated updateCourseRelated(
        org.nterlearning.datamodel.catalog.model.CourseRelated courseRelated)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateCourseRelated(courseRelated);
    }
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.CourseRelated updateCourseRelated(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateCourseRelated(courseRelated, merge);
    }
    ...
    */
    ...
    public static CourseRelatedLocalService getService() {
        if (_service == null) {
            Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    CourseRelatedLocalService.class.getName());
            ...
            _service = new CourseRelatedLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(CourseRelatedLocalServiceUtil.class,
                "_service");
            MethodCache.remove(CourseRelatedLocalService.class);
        }

        return _service;
    }

    public void setService(CourseRelatedLocalService service) {
        MethodCache.remove(CourseRelatedLocalService.class);
