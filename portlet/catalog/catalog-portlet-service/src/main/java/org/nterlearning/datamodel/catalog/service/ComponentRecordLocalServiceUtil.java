...
/**
 * The utility for the component record local service. This utility wraps {@link org.nterlearning.datamodel.catalog.service.impl.ComponentRecordLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class ComponentRecordLocalServiceUtil {
    private static ComponentRecordLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link org.nterlearning.datamodel.catalog.service.impl.ComponentRecordLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.ComponentRecord addComponentRecord(
        org.nterlearning.datamodel.catalog.model.ComponentRecord componentRecord)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addComponentRecord(componentRecord);
    }
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.ComponentRecord createComponentRecord(
        long componentRecordId) {
        return getService().createComponentRecord(componentRecordId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteComponentRecord(long componentRecordId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        getService().deleteComponentRecord(componentRecordId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteComponentRecord(
        org.nterlearning.datamodel.catalog.model.ComponentRecord componentRecord)
        throws com.liferay.portal.kernel.exception.SystemException {
        getService().deleteComponentRecord(componentRecord);
    }
    ...
    */
    ...
    public static org.nterlearning.datamodel.catalog.model.ComponentRecord fetchComponentRecord(
        long componentRecordId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchComponentRecord(componentRecordId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static org.nterlearning.datamodel.catalog.model.ComponentRecord getComponentRecord(
        long componentRecordId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getComponentRecord(componentRecordId);
    }
    ...
    */
    public static java.util.List<org.nterlearning.datamodel.catalog.model.ComponentRecord> getComponentRecords(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getComponentRecords(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getComponentRecordsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getComponentRecordsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static org.nterlearning.datamodel.catalog.model.ComponentRecord updateComponentRecord(
        org.nterlearning.datamodel.catalog.model.ComponentRecord componentRecord)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateComponentRecord(componentRecord);
    }
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.ComponentRecord updateComponentRecord(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateComponentRecord(componentRecord, merge);
    }
    ...
    */
    ...
    public static long countByCourseRecordIdUserIdLanguageFilter(
        long courseRecordId, long userId, java.util.Locale locale,
        java.lang.String filterType)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .countByCourseRecordIdUserIdLanguageFilter(courseRecordId,
    ...
    public static ComponentRecordLocalService getService() {
        if (_service == null) {
            Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ComponentRecordLocalService.class.getName());
            ...
            _service = new ComponentRecordLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(ComponentRecordLocalServiceUtil.class,
                "_service");
            MethodCache.remove(ComponentRecordLocalService.class);
        }

        return _service;
    }

    public void setService(ComponentRecordLocalService service) {
        MethodCache.remove(ComponentRecordLocalService.class);
