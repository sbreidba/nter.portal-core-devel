...
/**
 * The utility for the courses_ components local service. This utility wraps {@link org.nterlearning.datamodel.catalog.service.impl.Courses_ComponentsLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class Courses_ComponentsLocalServiceUtil {
    private static Courses_ComponentsLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link org.nterlearning.datamodel.catalog.service.impl.Courses_ComponentsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.Courses_Components addCourses_Components(
        org.nterlearning.datamodel.catalog.model.Courses_Components courses_Components)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addCourses_Components(courses_Components);
    }
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.Courses_Components createCourses_Components(
        long coursesComponentsId) {
        return getService().createCourses_Components(coursesComponentsId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteCourses_Components(long coursesComponentsId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        getService().deleteCourses_Components(coursesComponentsId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void deleteCourses_Components(
        org.nterlearning.datamodel.catalog.model.Courses_Components courses_Components)
        throws com.liferay.portal.kernel.exception.SystemException {
        getService().deleteCourses_Components(courses_Components);
    }
    ...
    */
    ...
    public static org.nterlearning.datamodel.catalog.model.Courses_Components fetchCourses_Components(
        long coursesComponentsId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchCourses_Components(coursesComponentsId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static org.nterlearning.datamodel.catalog.model.Courses_Components getCourses_Components(
        long coursesComponentsId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getCourses_Components(coursesComponentsId);
    }
    ...
    */
    public static java.util.List<org.nterlearning.datamodel.catalog.model.Courses_Components> getCourses_Componentses(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getCourses_Componentses(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getCourses_ComponentsesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getCourses_ComponentsesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static org.nterlearning.datamodel.catalog.model.Courses_Components updateCourses_Components(
        org.nterlearning.datamodel.catalog.model.Courses_Components courses_Components)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateCourses_Components(courses_Components);
    }
    ...
    */
    public static org.nterlearning.datamodel.catalog.model.Courses_Components updateCourses_Components(
        ...
        boolean merge)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateCourses_Components(courses_Components, merge);
    }
    ...
    */
    ...
    public static Courses_ComponentsLocalService getService() {
        if (_service == null) {
            Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    Courses_ComponentsLocalService.class.getName());
            ...
            _service = new Courses_ComponentsLocalServiceClp(classLoaderProxy);

            ClpSerializer.setClassLoader(portletClassLoader);

            ReferenceRegistry.registerReference(Courses_ComponentsLocalServiceUtil.class,
                "_service");
            MethodCache.remove(Courses_ComponentsLocalService.class);
        }

        return _service;
    }

    public void setService(Courses_ComponentsLocalService service) {
        MethodCache.remove(Courses_ComponentsLocalService.class);
